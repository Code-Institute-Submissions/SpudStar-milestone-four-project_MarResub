...
AUTHENTICATION_BACKENDS = (
    # Backends to aid login during project
...
if "USE_CLOUD" in os.environ:
    # Decided to store bucket name in enviromental
    AWS_STORAGE_BUCKET_NAME = os.getenv('BUCKET_KEY', '')
